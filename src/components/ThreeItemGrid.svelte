...
<div class="flex flex-col lg:h-full lg:flex-row gap-5 rounded-lg m-5">
  <div class="h-[60vh] w-full bg-dark lg:h-full lg:w-2/3 rounded-xl">
    <GridTile
      priority="eager"
  ...
  <div class="w-full lg:h-full lg:w-1/3">
    <div class="h-[60vh] w-full bg-light lg:h-1/2 rounded-xl">
      <GridTile
        priority="eager"
    ...
    <div class="h-[60vh] w-full bg-svelteOrange lg:h-1/2 rounded-xl gap-5 overflow-hidden">
      <GridTile
        priority="eager"
